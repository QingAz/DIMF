...
def main() -> None:
    ...
    rf_params_base = {
        ...
        "max_depth": None if rf_cfg.get("max_depth", None) is None else int(rf_cfg.get("max_depth")),
    ...
    for seed in seeds:
        print(f"\n########## Seed {seed} ##########")
        rf_params = dict(rf_params_base)
        rf_params["random_state"] = int(seed)
    ...
    out_dir = PROJECT_ROOT / "outputs" / "baseline_random_forest"
